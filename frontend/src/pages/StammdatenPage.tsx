 ...
 * Person moeglich (z.B. fuer die Auswahl bei der Mannschaftserfassung); Bearbeiten ist auf
 * Admin/Manager beschraenkt (siehe verein.ts/team.ts) - fuer alle anderen Rollen sind die
 * Formulare ueber ein disabled-<fieldset> in den Unterkomponenten gesperrt. */
